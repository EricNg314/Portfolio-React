  ...
  <div>
    <div className="parallax-100vh about_bg-img1">
      <div className="caption">
        <span className='text-light bg-dark h1 p-3 round-corner d-inline-block'>Welcome to my story.</span>

        <Link to="#aboutId"
          scroll={el => el.scrollIntoView({ behavior: 'smooth', block: 'start' })}
          className='fa fa-arrow-circle-down d-block about-arrow-styles my-4'></Link>
    ...
    <div id="aboutId" className='parallax-bg about_bg-img1 pt-2'>
      <div className='container'>
        ...
        <div className='bg-white box-shadow'>
          <h4 className='mt-0 mb-4 p-3'>Something was still missing inside me and realized I wanted to build applications. I took the leap of faith into UC Berkeley's Coding Bootcamp. After graduating, I am now a Teaching Assistant for their Data Analytics Bootcamp.</h4>
        </div>
      </div>
    </div>
